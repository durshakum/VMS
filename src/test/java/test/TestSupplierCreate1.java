...
public class TestSupplierCreate1 extends InvokeBrowser{
	
	
	@Test(dataProviderClass = DataExcel.class,dataProvider = "oneRowPerThread")
	public void supplierCreate(Map<String, String> rowData) throws Exception  {
		...
		CreateSupplierPage csp = new CreateSupplierPage(getDriver());
