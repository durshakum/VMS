...
//		 System.out.println(reportPath);
     ...
     public void onTestFailure(ITestResult result) {
      ...
      // Get driver instance from the test class instance using reflection
         ...
         try {
             // Try to call getDriver() method to get the driver
             driver = (WebDriver) testClassInstance.getClass().getMethod("getDriver").invoke(testClassInstance);
         } catch (Exception e) {
             e.printStackTrace();
         }
